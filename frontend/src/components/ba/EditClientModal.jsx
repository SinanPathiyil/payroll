...
import { X, Plus, Trash2, Building, Save } from "lucide-react";
    ...
    if (client && isOpen) {
      setFormData({
        ...
        contract_start_date: client.contract_start_date 
          ? new Date(client.contract_start_date).toISOString().split('T')[0] 
          : "",
        contract_end_date: client.contract_end_date 
          ? new Date(client.contract_end_date).toISOString().split('T')[0] 
          : "",
      ...
      >
        ...
        <div className="ba-modal-header">
          <div className="ba-modal-header-content">
            ...
            <h2 className="ba-modal-title">Edit Client</h2>
          </div>
