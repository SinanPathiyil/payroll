...
export default function EmployeeDashboard() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log('🔍 is_clocked_in type:', typeof statusRes.data?.is_clocked_in);
      console.log('═══════════════════════════════════');
      ...
      setStatus({
        is_clocked_in: statusData.is_clocked_in === true, // Explicit boolean check
        current_hours: statusData.current_hours || 0,
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-blue-600">
                  {status.current_hours?.toFixed(2) || '0.00'}
                </p>
              </div>
