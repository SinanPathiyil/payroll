...
export default function SuperAdminTeams() {
  ...
  const filterTeams = () => {
    ...
    if (statusFilter !== "") {
      filtered = filtered.filter(
        (t) => t.is_active === (statusFilter === "true")
      );
    }
  ...
  const handleCreateTeam = async (e) => {
    ...
    try {
      setSubmitting(true);
      const token = localStorage.getItem("token");
      await axios.post(`${import.meta.env.VITE_API_URL}/teams`, createForm, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      <div className="sat-container">
        ...
        <div className="sat-header">
          <div>
            ...
            <p className="sat-subtitle">Manage teams and team assignments</p>
          </div>
          <button
                    ...
                    <tr key={team.id}>
                      <td>
                        <div className="sat-team-cell">
                          ...
                          <div>
                            <div className="sat-team-name">
                              {team.team_name}
                            </div>
                            {team.description && (
                              <div className="sat-team-desc">
                                {team.description}
                              </div>
                            )}
                          </div>
                      ...
                      <td>
                        <span
                          className={`sat-status ${team.is_active ? "sat-status-active" : "sat-status-inactive"}`}
                        >
                          {team.is_active ? (
                            <>
            ...
            <div className="sat-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleCreateTeam}>
                <div className="sat-modal-body">
                  ...
                  <div className="sat-form-group">
                    ...
                    <textarea
                      ...
                      placeholder="Enter a brief description of the team's purpose..."
                      rows="3"
                    />
                  </div>
                  ...
                  <div className="sat-form-group">
                    ...
                    {teamLeads.length === 0 && (
                      <small className="sat-help-text">
                        No team leads available. Please create a team lead user
                        first.
                      </small>
                    )}
                  </div>
                ...
                <div className="sat-modal-footer">
                  ...
                  <button
                    type="submit"
                    disabled={submitting || teamLeads.length === 0}
            ...
            <div className="sat-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="sat-modal-body">
                <div className="sat-modal-warning">
                  ...
                  <p>
                    This will deactivate the team and remove all member
                    assignments!
                  </p>
                </div>
                <div className="sat-modal-info">
                  ...
                  <div>
                    <strong>Team Lead:</strong> {selectedTeam?.team_lead_name}
                  </div>
                  <div>
                    <strong>Members:</strong> {selectedTeam?.member_count}
                  </div>
                </div>
