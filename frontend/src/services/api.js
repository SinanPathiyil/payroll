...
export const getBARevenueAnalytics = (params) =>
  api.get("/ba/dashboard/revenue-analytics", { params });
export const getBAProjectAnalytics = (params) =>
  api.get("/ba/dashboard/project-analytics", { params });
...
export const getBAProjectDetails = (projectId) =>
  api.get(`/ba/projects/${projectId}`);
export const getBAProject = (projectId) => api.get(`/ba/projects/${projectId}`);
export const createBAProject = (projectData) =>
  api.post("/ba/projects/", projectData);
export const updateBAProject = (projectId, projectData) =>
  api.patch(`/ba/projects/${projectId}`, projectData);
export const getBAProjectStats = (projectId) =>
  api.get(`/ba/projects/${projectId}/stats`);
...
export const shareRequirementWithTL = (projectId, docId, teamLeadId) =>
  api.post(`/ba/projects/${projectId}/requirements/${docId}/share`, {
...
export const uploadRequirementDocument = async (
  ...
  return api.post(
    `/ba/projects/${projectId}/requirements/upload?version=${version}${notes ? `&notes=${notes}` : ""}`,
    formData,
    {
      headers: { "Content-Type": "multipart/form-data" },
    }
...
export const deleteBAProject = (projectId) =>
  api.delete(`/ba/projects/${projectId}`);

// ============================================
// BUSINESS ANALYST - PAYMENTS
// ============================================
export const recordPayment = (paymentData) =>
  api.post("/ba/payments/record", paymentData);
...
export const scheduleMeeting = (meetingData) =>
  api.post("/ba/meetings", meetingData);
...
export const cancelMeeting = (meetingId) =>
  api.delete(`/ba/meetings/${meetingId}`);
export const getUpcomingMeetingsCount = () =>
  api.get("/ba/meetings/upcoming/count");

// ============================================
// TEAM LEAD - DASHBOARD
// ============================================
export const getTLDashboardSummary = () =>
  api.get("/team-lead/dashboard/summary");

// ============================================
// TEAM LEAD - PROJECTS
// ============================================
export const getTLProjects = (params) =>
  api.get("/team-lead/projects", { params });
export const getTLPendingApprovalProjects = () =>
  api.get("/team-lead/projects/pending-approval");
export const getTLActiveProjects = () => api.get("/team-lead/projects/active");
export const getTLProject = (projectId) =>
  api.get(`/team-lead/projects/${projectId}`);
...
export const approveRequirement = (projectId, docId, data) =>
  api.post(`/team-lead/projects/${projectId}/requirements/approve`, {
    doc_id: docId,
    approved: true,
    approval_notes: (data && (data.notes || data.approval_notes)) || "",
  });
...
export const rejectRequirement = (projectId, docId, data) =>
  api.post(`/team-lead/projects/${projectId}/requirements/approve`, {
    doc_id: docId,
    approved: false,
    approval_notes: (data && (data.notes || data.rejection_notes)) || "",
  });
...
export const createTLTask = (taskData) =>
  api.post("/team-lead/tasks/create", taskData);
...
export const createUser = (userData) =>
  api.post("/hr/employees/create", userData);
...
export const getEmployeeStats = (employeeId) =>
  api.get(`/hr/employee/${employeeId}/stats`);
...
// HR - LEAVE MANAGEMENT
// ============================================
export const getHRLeavePendingApprovals = () =>
  api.get("/hr/leave/pending-approvals");
export const getHRAllLeaveRequests = (params) =>
  api.get("/hr/leave/all-requests", { params });
...
export const logActivity = (activityData) =>
  api.post("/employee/activity", activityData);
...
export const applyForLeave = (leaveData) =>
  api.post("/employee/leave/apply", leaveData);
export const getMyLeaveHistory = (params) =>
  api.get("/employee/leave/history", { params });
export const cancelLeaveRequest = (requestId, data) =>
  api.post(`/employee/leave/${requestId}/cancel`, data);
export const getTeamLeaveCalendar = (month, year) =>
  api.get("/employee/leave/team-calendar", { params: { month, year } });
...
export const updateTask = (taskId, updateData) =>
  api.patch(`/tasks/${taskId}`, updateData);
...
export const getTaskDeliverables = (taskId) =>
  api.get(`/tasks/${taskId}/deliverables`);
...
export const updateTeam = (teamId, teamData) =>
  api.patch(`/teams/${teamId}`, teamData);
...
export const submitActivity = (activityData) =>
  api.post("/agent/activity", activityData);
export const uploadScreenshot = (formData) =>
  api.post("/agent/screenshot", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
...
// SUPER ADMIN
// ============================================
export const createHRUser = (userData) =>
  api.post("/super-admin/users/hr", userData);
export const createBAUser = (userData) =>
  api.post("/super-admin/users/business-analyst", userData);
export const createSuperAdmin = (userData) =>
  api.post("/super-admin/users/super-admin", userData);
export const getAllUsers = (params) =>
  api.get("/super-admin/users", { params });
export const getUser = (userId) => api.get(`/super-admin/users/${userId}`);
export const updateUser = (userId, userData) =>
  api.patch(`/super-admin/users/${userId}`, userData);
...
export const getOverrideRequests = () =>
  api.get("/super-admin/override-requests");
